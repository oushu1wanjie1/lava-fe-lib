...
export const messages: Record<string, { common: Record<string, string>, errors: Record<string, string> }> = {
  'zh-CN': {
    ...
    errors: {
      ...
      // dashboard
      'lava.error.createDashboard.nameIsRepeated': '仪表板名称重复',
      'lava.error.dashboard.nameIsIllegal': '仪表板名称不合法',
      'lava.error.panel.titleIsIllegal': '面板标题名称不合法',
      'lava.copyDashboard.nameIsTooLongToBeCopied': '仪表板名称过长不可复制',
      'lava.error.dashboardNotExist': '仪表板不存在',
      'lava.error.dashboardReadyOverview': '仪表板已经被设为总览仪表板',
