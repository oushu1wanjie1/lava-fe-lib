...
export default {
  'zh-CN': {
    ...
    // 错误
    errors: {
      COMMON_ERROR_INTERNAL: '系统错误',
      COMMON_ERROR_REQUEST_UNMARSHAL: '请求参数错误',
      LAVA_ERROR_CHANGE_PASSWORD_PASSWORD_FORMAT: '请输入正确的8-50位由数字，字母（包含大小写）和符号组合的密码',
      ...
      LAVA_ERROR_LOGIN_NEED_APPROVE: '该用户正在审批中，请联系主账号确认',
      LAVA_ERROR_LOGIN_NEW_USER: '新用户，需要重置密码',
      LAVA_ERROR_LOGIN_PASSWORD_EXPIRED: '密码已过期，需要重置密码',
      LAVA_ERROR_LOGIN_PASSWORD_RESET: '需要重置密码',
      LAVA_ERROR_LOGIN_USER_INACTIVE: '用户未激活',
      LAVA_ERROR_LOGIN_USER_NOT_APPROVED: '用户审批未通过',
